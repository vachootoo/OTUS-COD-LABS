...
Каждому устройству назначается уникальный `/32` адрес на интерфейсе `Loopback0` и номер автономной системы ASN.

| Device | Interface | IP address | ASN |
|---|---|---|---|
| Spine-1 | Loopback0 | `10.255.0.1/32` | 65000 |
| Spine-2 | Loopback0 | `10.255.0.2/32` | 65000 |
| Leaf-1 | Loopback0 | `10.255.0.11/32` | 65101 |
| Leaf-2 | Loopback0 | `10.255.0.12/32` | 65102 |
| Leaf-3 | Loopback0 | `10.255.0.13/32` | 65103 |
...
router isis UNDERLAY
 ...
 authentication key MyGlobalSecretKey
```
На интерфейсах:
```
Interface Ethernet 1
 isis authentication mode md5
 isis authentication key MyInterfaceSecretKey
...
### Проверка
```
Spine-1(config)#sh bfd peers
VRF name: default
-----------------
DstAddr       MyDisc    YourDisc  Interface/Transport    Type           LastUp
--------- ----------- ----------- -------------------- ------- ----------------
10.0.1.1  3551027779  2389349378        Ethernet1(25)  normal   09/02/26 10:25
10.0.1.3  1038953095  2872589125        Ethernet2(23)  normal   09/02/26 10:38
10.0.1.5  3049631847  2068491003        Ethernet3(24)  normal   09/02/26 10:38
...
Instance  VRF      System Id        Type Interface          SNPA              State Hold time   Circuit Id
UNDERLAY  default  Leaf-1           L2   Ethernet1          P2P               UP    27          14
UNDERLAY  default  Leaf-2           L2   Ethernet2          P2P               UP    28          17
UNDERLAY  default  Leaf-3           L2   Ethernet3          P2P               UP    28          15
```
